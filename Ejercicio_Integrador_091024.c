...
int main(){
    ...
    do{
        opcMenu = menu();
        switch(opcMenu){
            case 1: cargarEmpleados(empleados); break;
            case 2: informeDeSueldos(empleados); break;
            case 3: filtrarEmpleadosPorHoras(empleados , empleadosPocasHoras); break;
            case 4: sueldosPorCategoria(empleados); break;
            case 5: cantidadEmpleadosPorCategoria(empleados); break;
        }
    }while(opcMenu!=SALIR);
...
void sueldosPorCategoria(registro_t empleados[MAX_EMP]){
    ...
    do{
        switch(empleados[cont].cat){
            case 1:
                acumCat[0] = acumCat[0] + empleados[cont].sue; break;
            case 2:
                acumCat[1] = acumCat[1] + empleados[cont].sue; break;
            case 3:
                acumCat[2] = acumCat[2] + empleados[cont].sue; break;
            case 4:
                acumCat[3] = acumCat[3] + empleados[cont].sue; break;
        }
        cont++;
    }while(empleados[cont].cod!=0);
    ...
    for(i=0;i<4;i++){
        printf("La categoria %d acumuló $%f\n", categorias[i] , acumCat[i]);
    }
    printf("\n");
}
...
void cantidadEmpleadosPorCategoria(registro_t empleados[MAX_EMP]){
    ...
    do{
        switch(empleados[cont].cat){
            case 1:
                cantCategorias[0]++; break;
            case 2:
                cantCategorias[1]++; break;
            case 3:
                cantCategorias[2]++; break;
            case 4:
                cantCategorias[3]++; break;
        }
        cont++;
    }while(empleados[cont].cod!=0);
